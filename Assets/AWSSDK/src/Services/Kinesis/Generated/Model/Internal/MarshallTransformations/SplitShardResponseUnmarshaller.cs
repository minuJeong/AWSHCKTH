...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SplitShardResponseUnmarshaller : JsonResponseUnmarshaller    {
        /// <summary>
        ...
        {
            SplitShardResponse response = new SplitShardResponse();
        ...
        private static SplitShardResponseUnmarshaller _instance = new SplitShardResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SplitShardResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
