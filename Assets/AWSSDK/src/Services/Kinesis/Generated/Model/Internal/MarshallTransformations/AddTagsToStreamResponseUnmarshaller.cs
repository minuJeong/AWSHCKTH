...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddTagsToStreamResponseUnmarshaller : JsonResponseUnmarshaller    {
        /// <summary>
        ...
        {
            AddTagsToStreamResponse response = new AddTagsToStreamResponse();
        ...
        private static AddTagsToStreamResponseUnmarshaller _instance = new AddTagsToStreamResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddTagsToStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
