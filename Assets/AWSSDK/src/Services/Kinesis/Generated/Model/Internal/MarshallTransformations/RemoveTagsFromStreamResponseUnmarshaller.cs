...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveTagsFromStreamResponseUnmarshaller : JsonResponseUnmarshaller    {
        /// <summary>
        ...
        {
            RemoveTagsFromStreamResponse response = new RemoveTagsFromStreamResponse();
        ...
        private static RemoveTagsFromStreamResponseUnmarshaller _instance = new RemoveTagsFromStreamResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveTagsFromStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
