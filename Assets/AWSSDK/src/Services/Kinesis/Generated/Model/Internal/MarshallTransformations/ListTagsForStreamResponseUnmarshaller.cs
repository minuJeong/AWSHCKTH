...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTagsForStreamResponseUnmarshaller : JsonResponseUnmarshaller    {
        /// <summary>
        ...
        {
            ListTagsForStreamResponse response = new ListTagsForStreamResponse();
        ...
        private static ListTagsForStreamResponseUnmarshaller _instance = new ListTagsForStreamResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTagsForStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
