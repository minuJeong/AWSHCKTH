...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeStreamResponseUnmarshaller : JsonResponseUnmarshaller    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("StreamDescription", targetDepth))
                {
                    ...
                    response.StreamDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeStreamResponseUnmarshaller _instance = new DescribeStreamResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
