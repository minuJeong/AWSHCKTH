...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteVerifiedEmailAddressRequestMarshaller : IMarshaller<IRequest, DeleteVerifiedEmailAddressRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteVerifiedEmailAddressRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteVerifiedEmailAddressRequest publicRequest)
        {
