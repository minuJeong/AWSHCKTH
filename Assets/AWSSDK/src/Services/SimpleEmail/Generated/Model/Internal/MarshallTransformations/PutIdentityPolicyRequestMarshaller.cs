...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutIdentityPolicyRequestMarshaller : IMarshaller<IRequest, PutIdentityPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutIdentityPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutIdentityPolicyRequest publicRequest)
        {
