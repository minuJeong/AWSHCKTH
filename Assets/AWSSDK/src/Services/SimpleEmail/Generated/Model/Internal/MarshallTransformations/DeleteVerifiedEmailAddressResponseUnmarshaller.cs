...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteVerifiedEmailAddressResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteVerifiedEmailAddressResult", 2))
                    {
        ...
        private static DeleteVerifiedEmailAddressResponseUnmarshaller _instance = new DeleteVerifiedEmailAddressResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVerifiedEmailAddressResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
