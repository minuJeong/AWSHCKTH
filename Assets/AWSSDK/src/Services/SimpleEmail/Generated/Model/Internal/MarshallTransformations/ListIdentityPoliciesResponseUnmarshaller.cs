...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListIdentityPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIdentityPoliciesResponse response = new ListIdentityPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListIdentityPoliciesResult", 2))
                    {
        ...
        private static ListIdentityPoliciesResponseUnmarshaller _instance = new ListIdentityPoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIdentityPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
