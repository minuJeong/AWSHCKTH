...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VerifyDomainIdentityResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            VerifyDomainIdentityResponse response = new VerifyDomainIdentityResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("VerifyDomainIdentityResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("VerificationToken", targetDepth))
                    {
                        ...
                        response.VerificationToken = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static VerifyDomainIdentityResponseUnmarshaller _instance = new VerifyDomainIdentityResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifyDomainIdentityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
