...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListVerifiedEmailAddressesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListVerifiedEmailAddressesResult", 2))
                    {
        ...
        private static ListVerifiedEmailAddressesResponseUnmarshaller _instance = new ListVerifiedEmailAddressesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVerifiedEmailAddressesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
