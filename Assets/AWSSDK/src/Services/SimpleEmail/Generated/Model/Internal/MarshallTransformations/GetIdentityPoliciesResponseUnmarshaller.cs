...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetIdentityPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetIdentityPoliciesResponse response = new GetIdentityPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetIdentityPoliciesResult", 2))
                    {
        ...
        private static GetIdentityPoliciesResponseUnmarshaller _instance = new GetIdentityPoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIdentityPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
