...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteIdentityPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteIdentityPolicyResponse response = new DeleteIdentityPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteIdentityPolicyResult", 2))
                    {
        ...
        private static DeleteIdentityPolicyResponseUnmarshaller _instance = new DeleteIdentityPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteIdentityPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
