...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListIdentityPoliciesRequestMarshaller : IMarshaller<IRequest, ListIdentityPoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListIdentityPoliciesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListIdentityPoliciesRequest publicRequest)
        {
