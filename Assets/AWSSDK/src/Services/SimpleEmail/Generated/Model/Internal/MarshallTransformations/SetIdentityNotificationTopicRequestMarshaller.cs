...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SetIdentityNotificationTopicRequestMarshaller : IMarshaller<IRequest, SetIdentityNotificationTopicRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SetIdentityNotificationTopicRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SetIdentityNotificationTopicRequest publicRequest)
        {
