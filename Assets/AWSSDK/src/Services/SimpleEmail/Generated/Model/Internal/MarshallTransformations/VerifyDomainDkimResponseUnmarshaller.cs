...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VerifyDomainDkimResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            VerifyDomainDkimResponse response = new VerifyDomainDkimResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("VerifyDomainDkimResult", 2))
                    {
        ...
        private static VerifyDomainDkimResponseUnmarshaller _instance = new VerifyDomainDkimResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifyDomainDkimResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
