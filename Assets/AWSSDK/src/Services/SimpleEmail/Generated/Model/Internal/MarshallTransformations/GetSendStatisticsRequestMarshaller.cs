...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSendStatisticsRequestMarshaller : IMarshaller<IRequest, GetSendStatisticsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSendStatisticsRequest)input);
        }
