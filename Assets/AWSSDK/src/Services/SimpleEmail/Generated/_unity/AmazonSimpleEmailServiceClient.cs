...
namespace Amazon.SimpleEmail
{
    ...
    /// </summary>
    public partial class AmazonSimpleEmailServiceClient : AmazonUnityServiceClient, IAmazonSimpleEmailService
    {
        #region Constructors
        ...
        {
            pipeline.ReplaceHandler<Amazon.Runtime.Internal.ErrorHandler>(new Amazon.Runtime.Internal.ErrorHandler<AmazonSimpleEmailServiceException>(this.Logger));
        }    
