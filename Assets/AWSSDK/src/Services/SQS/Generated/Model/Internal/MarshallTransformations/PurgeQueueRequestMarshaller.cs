...
namespace Amazon.SQS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PurgeQueueRequestMarshaller : IMarshaller<IRequest, PurgeQueueRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PurgeQueueRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PurgeQueueRequest publicRequest)
        {
