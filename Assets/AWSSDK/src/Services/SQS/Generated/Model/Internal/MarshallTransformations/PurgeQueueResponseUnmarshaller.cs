...
namespace Amazon.SQS.Model.Internal.MarshallTransformations
{
    ...
    public class PurgeQueueResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new PurgeQueueInProgressException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PurgeQueueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
